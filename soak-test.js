...
const phases = [
    {
        ...
        setup: (world) => {
            world.objects = [
                { id: 'terminal-01', type: 'terminal', interactive: true, pos: { x: 10, y: 0, z: -5 } },
            ]
            world.signals = null
    ...
    },
    {
        ...
        setup: (world) => {
            world.objects = [
                { id: 'terminal-01', type: 'terminal', interactive: true, pos: { x: 10, y: 0, z: -5 } },
                { id: 'beacon-01', type: 'beacon', interactive: true, pos: { x: -15, y: 0, z: 8 } },
                { id: 'crystal-01', type: 'crystal', interactive: false, pos: { x: 5, y: 0, z: 20 } },
            ]
            world.agents = [
    ...
    },
    {
        ...
        durationMin: 5,
        setup: (world) => {
            world.pendingSpeech = [{ agentId: 'scout', message: 'I found something strange near the beacon' }]
            world.speechEvent = { event: 'agent_speech', agentId: 'scout', message: 'I found something strange near the beacon' }
        },
    },
    {
